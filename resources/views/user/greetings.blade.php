                        ...
                        <div class="col-sm row no-gutters">
                            <div class="col-md align-self-center row no-gutters greeting-details">
                                ...
                                <div class="col-md-auto greeting-buttons ml-md-1">
                                    <button type="submit" name="greeting_id" value="{{ $greeting->id }}" class="btn btn-secondary mr-1" form="editGreetingForm{{ $greeting->id }}">
                                        {{ __('Edit') }}
                                    </button>
                                    <button type="submit" name="greeting_id" value="{{ $greeting->id }}" class="btn btn-primary ml-1" form="deleteGreetingForm{{ $greeting->id }}" >
                                        {{ __('Delete') }}
                                    </button>
                                </div>
                            </div>
